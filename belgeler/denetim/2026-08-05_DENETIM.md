...
>
> ⚠ **ÇAKIŞMA YASAĞI — kasten uygulandı.** `belgeler/denetim/2026-08-05_V1-SON-KONTROL.md`'nin ölçtüğü hiçbir sayı
...
2. **Kapısı `§C/14`'tür** — *"yeni bir tenant için ilk doğru cevaba kadar İNSAN-SAAT"*.
   `belgeler/denetim/2026-08-05_V1-SON-KONTROL.md` ölçüt 14'ü ✅ sayıyor; **ölçütün ölçüm aracı ise bu madde.**
...
⚠ Aşağıdakiler `belgeler/denetim/2026-08-05_V1-SON-KONTROL.md`'nin ölçüt yargılarını **tekrar etmiyor**, onlara
...
Aşağıdaki üç grup **kapı durumuyla** ayrıldı; `belgeler/denetim/2026-08-05_V1-SON-KONTROL.md`'nin sayısı tekrar
...
**Bulundu** *(hepsi yeni; birinci turda ve `belgeler/denetim/2026-08-05_V1-SON-KONTROL.md`'de yok)*:
