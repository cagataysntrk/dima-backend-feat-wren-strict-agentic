...
class StructuredJsonFastCognition:
    ...
    def draft(self, *, question: str) -> AskDraft:
        system = (
            ...
            "Search terms are metadata-discovery lookup terms for the primary business/data entity, "
            "not a copy of the user's wording. Every search term must independently help retrieve "
            "that entity/table. Keep useful user-language entity terminology when helpful. When the "
            "user question is not in English, include at least one likely English entity/table lookup "
            "term because database/schema metadata may use English names. Do not emit aggregation or "
            "operation words as table-search terms. Do not emit measure names, breakdown dimensions, "
            "or entity+metric phrases unless they are strictly required to distinguish the resource. "
            "Prefer standalone entity/table nouns. Use at most four search terms. "
