...
#: 🔴 FAZ 7 tavan borcu — `cube_query_json_schema` **`app/intent_semasi.py`'ye taşındı**
#: (modül 1749/1741'i aşmıştı). Taşınan şey bir **veri sözleşmesidir**, bir yönlendirme
#: kararı değil: `cube_router` *"hangi cube, hangi ölçü"*nün sahibidir, *"bir
#: Intent-JSON nasıl görünür"*ünkü değil. ⚠ Yeniden-ihraç **bilinçli**: dört çağrı yeri
#: (`ask.py` · iki test · `lab/faz3a_sema_kazanci.py`) `cube_router` üzerinden çağırıyor
#: ve o adı kırmak, bir tavan borcunu bir **API kırılmasına** çevirirdi.
