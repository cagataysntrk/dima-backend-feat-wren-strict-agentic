...
#: `ai_generated_prose` + `kanit_sinifi` ekledi) — ve bu **tümleyenin işe yaradığının
#: kanıtıdır**: iki yeni alan için buraya **hiçbir şey yazılmadı**, yine de kapsandılar.
...
def apply_to_ask_response(resp, principal) -> bool:
    ...
    # maskeleniyordu; `AskResponse`'un (o gün 29, bugün 31) alanının geri kalanı — `narration` (LLM metni,
