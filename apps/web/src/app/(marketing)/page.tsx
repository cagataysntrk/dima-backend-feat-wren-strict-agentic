    ...
    <>
      ...
      <section className="border-b py-16 sm:py-24" aria-labelledby="textile-title">
        <Container className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <Reveal><div className="relative overflow-hidden rounded-[1.2rem] border"><MarketingEditorialImage asset="floor" alt={tr ? "Boyahane üretim hattı" : "Textile dyehouse production floor"} className="aspect-[16/10]" sizes="(min-width: 1024px) 60vw, 100vw" /><div aria-hidden="true" className="absolute inset-0 bg-gradient-to-t from-foreground/55 via-transparent to-transparent" /><div className="absolute inset-x-5 bottom-5 text-background sm:inset-x-7 sm:bottom-7"><span className="text-lg font-medium">{tr ? "Parti · makine · reçete · termin" : "Batch · machine · recipe · deadline"}</span></div></div></Reveal>
