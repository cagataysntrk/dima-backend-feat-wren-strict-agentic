...
export default async function Page() { const c = getMarketingContent(await getLocale()); return <EvidenceDetailPage kind="security" page={c.pages.security} content={c} />; }
