...
export function ReportCard({
  ...
  return (
    <div className="mx-auto max-w-4xl px-8 py-7">
      ...
      {/* 🔴 BELİRSİZLİK chip'leri (`suggestions[].kind === "tanim"`) — KÖK-9.
          ÜÇÜNCÜ bir edim: "devam sorusu" bu cevabın ÜSTÜNDE konuşur, "sonraki adım"
          bu SORGUYU düzenler; bu ise AYNI SORUYU BAŞKA BİR TANIMLA yeniden sorar.
          ⚠️ Devam sorusu kutusuna konamaz: o kutunun açıklaması "yeni sorgu yazılmaz"
          diyor ve bu chip TAM DA yeni bir sorgu yazıyor. Bir chip'in yanındaki
          açıklama, chip'in kendisi kadar bir vaattir.
