  ...
  pages: {
    ...
    how: {
      ...
      sections: [
        ...
        { id: "guard", title: "4. Sorgu biçimini sınırla", body: "SELECT/WITH-only guard yazma ve silme komutlarını kabul etmez. Bu tek başına tüm riski ortadan kaldırdığı anlamına gelmez." },
        { id: "dry-plan", title: "5. Dry-plan ile doğrula", body: "Sorgunun semantic model üzerinden hedef motor tarafından planlanabildiği çalıştırmadan önce sınanır; iş sonucunun mutlak doğruluğu garanti edilmez." },
        { id: "execute", title: "6. Çalıştır ve kanıtı göster", body: "İzinli sorgu çalışır; sonuç, SQL, kaynak ve çözüm izi kullanıcıya birlikte sunulur." },
    ...
    about: {
      ...
      sections: [
        ...
        { id: "company", title: "UpcyTech", body: "UpcyTech, operasyonel verimlilik ve endüstriyel dijitalleşme için yazılım ürünleri geliştirir. Dima bu ürün ekosisteminin analitik katmanıdır." },
  ...
  pages: {
    ...
    how: {
      ...
      sections: [
        ...
        { id: "guard", title: "4. Bound the query shape", body: "The SELECT/WITH guard rejects write and delete commands. This alone does not eliminate all risk." },
        { id: "dry-plan", title: "5. Validate with a dry plan", body: "The target engine checks whether the query can be planned through the semantic model before execution; absolute business correctness is not guaranteed." },
        { id: "execute", title: "6. Execute and show evidence", body: "The permitted query runs; result, SQL, source, and trace appear together." },
    ...
    about: {
      ...
      sections: [
        ...
        { id: "company", title: "UpcyTech", body: "UpcyTech builds software for operational efficiency and industrial digitalization. Dima is the analytics layer of this product ecosystem." },
