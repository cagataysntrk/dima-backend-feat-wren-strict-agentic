...
export default async function Page() { const c = getMarketingContent(await getLocale()); return <DetailPage page={c.pages.integrations} content={c} visual={<PageVisualStage variant="integration" locale={c.locale} />} />; }
