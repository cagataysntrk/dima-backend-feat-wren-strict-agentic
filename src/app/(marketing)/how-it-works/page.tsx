...
export default async function Page() { const c = getMarketingContent(await getLocale()); return <EvidenceDetailPage kind="how" page={c.pages.how} content={c} heroVisual={<PageVisualStage variant="validation" locale={c.locale} />} />; }
