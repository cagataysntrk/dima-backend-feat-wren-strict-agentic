    ...
    <section className="relative overflow-hidden py-16 sm:py-24">
      ...
      <Container className="relative grid gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
        <Reveal>
          ...
          <p className="mt-6 max-w-lg text-lg leading-8 text-muted-foreground">{tr ? "Veri kaynağınızı, mevcut rapor akışınızı ve doğrulanması gereken ilk soruyu paylaşın." : "Tell us about your data source, reporting flow, and the first question that needs validation."}</p>
